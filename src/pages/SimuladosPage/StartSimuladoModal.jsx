    ...
    <div className="fixed inset-0 z-[80] flex items-center justify-center p-4 bg-zinc-900/60 backdrop-blur-md animate-fade-in font-sans">
      ...
      >
        ...
        <div className="relative bg-red-600 px-5 py-4 overflow-hidden">
          <div className="absolute -right-6 -bottom-10 opacity-15 transform -rotate-12 pointer-events-none">
          ...
          <div className="relative z-10 flex justify-between items-start">
            <div>
              ...
              <h3 className="text-xl font-black text-white tracking-tight">Iniciar Simulado</h3>
        ...
        <div className="p-4 space-y-4 sm:p-5 sm:space-y-5">
          ...
          <div className="space-y-2">
            ...
            <div className="grid grid-cols-2 gap-3">
              <button onClick={() => setMode('free')} className={`relative p-3 rounded-2xl border-2 transition-all flex flex-col items-center justify-center gap-2 group ${mode === 'free' ? 'border-red-500 bg-red-50 dark:bg-red-900/20 text-red-600 dark:text-red-400 shadow-lg shadow-red-500/10' : 'border-zinc-100 dark:border-zinc-800 bg-white dark:bg-zinc-900 text-zinc-400 hover:border-red-200 dark:hover:border-red-900/50 hover:bg-zinc-50'}`}>
              ...
              <button onClick={() => setMode('countdown')} className={`relative p-3 rounded-2xl border-2 transition-all flex flex-col items-center justify-center gap-2 group ${mode === 'countdown' ? 'border-red-500 bg-red-50 dark:bg-red-900/20 text-red-600 dark:text-red-400 shadow-lg shadow-red-500/10' : 'border-zinc-100 dark:border-zinc-800 bg-white dark:bg-zinc-900 text-zinc-400 hover:border-red-200 dark:hover:border-red-900/50 hover:bg-zinc-50'}`}>
          ...
          <AnimatePresence>
            {mode === 'countdown' && (
              <motion.div initial={{ opacity: 0, height: 0, marginTop: 0 }} animate={{ opacity: 1, height: 'auto', marginTop: 16 }} exit={{ opacity: 0, height: 0, marginTop: 0 }} className="overflow-hidden">
                <div className="p-4 bg-zinc-50 dark:bg-zinc-900/50 rounded-2xl border border-zinc-200 dark:border-zinc-800 flex flex-col items-center">
                  ...
                  <div className="flex items-center gap-4">
                    <div className="flex flex-col items-center">
                      <input type="number" value={hours} onChange={e => setHours(e.target.value)} className="w-16 h-16 text-center text-3xl font-black bg-white dark:bg-zinc-900 rounded-2xl border-2 border-zinc-200 dark:border-zinc-700 focus:border-red-500 focus:ring-4 focus:ring-red-500/10 outline-none transition-all shadow-sm text-zinc-800 dark:text-white sm:h-20 sm:w-20 sm:text-4xl" placeholder="04" />
                    ...
                    <div className="flex flex-col items-center">
                      <input type="number" value={minutes} onChange={e => setMinutes(e.target.value)} className="w-16 h-16 text-center text-3xl font-black bg-white dark:bg-zinc-900 rounded-2xl border-2 border-zinc-200 dark:border-zinc-700 focus:border-red-500 focus:ring-4 focus:ring-red-500/10 outline-none transition-all shadow-sm text-zinc-800 dark:text-white sm:h-20 sm:w-20 sm:text-4xl" placeholder="00" />
