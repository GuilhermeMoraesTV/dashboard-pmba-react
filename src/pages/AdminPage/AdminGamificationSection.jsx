...
import { AlertTriangle, Gamepad2, RefreshCw, ShieldCheck, Trophy, Users } from 'lucide-react';
...
const AdminGamificationSection = ({ users = [], loading, onOpenUser, onFeedback }) => {
  ...
  const diagnostics = useMemo(() => {
    ...
    return { withoutProfile, invalidXp };
  }, [users]);
  ...
  return (
    <section className="space-y-5">
      <div className="rounded-[28px] border border-zinc-200 bg-gradient-to-br from-white to-red-50 p-5 shadow-sm dark:border-zinc-800 dark:from-card-dark dark:to-red-950/10">
        ...
        <h2 className="mt-2 text-2xl font-black tracking-tight text-zinc-900 dark:text-white">Integridade de XP e níveis</h2>
