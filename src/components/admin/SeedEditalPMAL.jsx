  ...
  disciplinas: [
    {
      ...
      assuntos: [
        ...
        { nome: "Concordância verbal e nominal", relevancia: 5 }, // Clássico Cebraspe
        ...
        { nome: "Reescrita de frases e parágrafos (significação, substituição, reorganização)", relevancia: 5 } // Muito cobrado em certo/errado
      ]
    },
    {
      ...
      assuntos: [
        ...
        { nome: "Computação na nuvem (cloud computing) e armazenamento", relevancia: 4 }, // Tema moderno
    ...
    },
    {
      nome: "Matemática",
      peso: 1,
      importancia: "Alta", // Costuma ser o diferencial
      assuntos: [
        ...
        { nome: "Modelos exponenciais e logarítmicos", relevancia: 2 }, // Difícil, mas cai
        { nome: "Princípios de contagem (Análise Combinatória)", relevancia: 5 }, // Muito recorrente
    ...
    },
    {
      ...
      assuntos: [
        ...
        { nome: "História de Alagoas: colonização e povoamento", relevancia: 5 }, // Foco regional
    ...
    },
    {
      ...
      assuntos: [
        ...
        { nome: "Aspectos geográficos do estado de Alagoas", relevancia: 5 } // Essencial
      ]
    },
    {
      ...
      assuntos: [
        { nome: "Estatuto dos Policiais Militares de AL (Lei 5.346/1992)", relevancia: 5 }, // Obrigatório dominar
        ...
        { nome: "Código Penal (Parte Geral): Título II - Do Crime", relevancia: 5 }, // Teoria do Crime
    ...
    },
    {
      ...
      assuntos: [
        ...
        { nome: "Princípios e Regime jurídico administrativo", relevancia: 5 }, // LIMPE
    ...
    },
    {
      ...
      importancia: "Alta",
      assuntos: [
        { nome: "Direitos e garantias fundamentais (Art. 5º)", relevancia: 5 }, // Top 1 da prova
    ...
    },
    {
      ...
      importancia: "Alta",
      assuntos: [
        { nome: "Inquérito policial", relevancia: 5 }, // Essencial para carreira policial
    ...
    },
    {
      ...
      assuntos: [
        ...
        { nome: "Convenção Americana sobre Direitos Humanos (Pacto de São José)", relevancia: 5 } // O mais cobrado
      ]
    }
  ]
};
