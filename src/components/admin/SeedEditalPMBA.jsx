  ...
  disciplinas: [
    {
      ...
      assuntos: [
        ...
        { nome: "Uso do sinal indicativo de crase", relevancia: 4 },
    ...
    },
    {
      ...
      assuntos: [
        ...
        { nome: "História da Bahia", relevancia: 5 },
        { nome: "Independência da Bahia", relevancia: 5 },
        { nome: "Revolta de Canudos", relevancia: 5 },
    ...
    },
    {
      ...
      assuntos: [
        ...
        { nome: "Geografia da Bahia: aspectos políticos, físicos, econômicos, sociais e culturais", relevancia: 5 }
      ]
    },
    {
      nome: "Matemática",
      ...
      assuntos: [
        ...
        { nome: "Análise combinatória e Probabilidade", relevancia: 5 },
    ...
    },
    {
      ...
      assuntos: [
        ...
        { nome: "Segurança Pública", relevancia: 5 },
    ...
    },
    {
      ...
      assuntos: [
        ...
        { nome: "Princípios fundamentais da administração pública", relevancia: 5 },
        { nome: "Poderes e deveres (vinculado, discricionário, hierárquico, disciplinar, polícia)", relevancia: 5 },
    ...
    },
    {
      ...
      assuntos: [
        ...
        { nome: "Causas de exclusão de ilicitude e culpabilidade", relevancia: 5 },
    ...
    },
    {
      ...
      assuntos: [
        ...
        { nome: "Crimes de Racismo (Leis 7.716/89 e 9.459/97)", relevancia: 5 },
    ...
    },
    {
      ...
      assuntos: [
        ...
        { nome: "Crimes contra serviço/dever militar (deserção, abandono, embriaguez)", relevancia: 5 },
