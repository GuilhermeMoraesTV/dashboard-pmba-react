  ...
  disciplinas: [
    ...
    },
    {
      ...
      assuntos: [
        ...
        { nome: "Propriedades dos fluidos: massa específica e densidade; empuxo; pressão hidrostática", relevancia: 5 },
    ...
    },
    {
      ...
      assuntos: [
        ...
        { nome: "Gráficos e tabelas: análise", relevancia: 5 },
    ...
    },
    {
      ...
      assuntos: [
        ...
        { nome: "Combustíveis: reação de combustão; poder calorífico", relevancia: 5 },
    ...
    },
    {
      ...
      assuntos: [
        ...
        { nome: "Organização espacial, social e econômica do estado do Rio de Janeiro", relevancia: 5 },
    ...
    },
    {
      ...
      assuntos: [
        ...
        { nome: "Implícitos: inferência, pressuposição, subentendido", relevancia: 5 },
    ...
    },
    {
      ...
      assuntos: [
        ...
        { nome: "Métodos de argumentação: indutivo, dedutivo, dialético", relevancia: 5 },
...
export const editalConfig = {
    ...
    banca: "UERJ",
    tipo: "cbm",
    logo: "/logosEditais/logo-cbmerj.png"
};
