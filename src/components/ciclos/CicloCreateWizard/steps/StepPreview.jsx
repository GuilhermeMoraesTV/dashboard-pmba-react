    ...
    <div className="flex flex-col h-full overflow-hidden w-full">
      ...
      <div className="w-full px-2 sm:px-4 lg:px-8 overflow-y-auto custom-scrollbar pb-10">
        <div className="grid grid-cols-1 xl:grid-cols-[minmax(0,1fr)_340px] gap-4 md:gap-5 items-start">
          ...
          <div className="order-2 h-[610px] rounded-[24px] border border-zinc-200 bg-white p-1.5 shadow-sm dark:border-zinc-800 dark:bg-zinc-900/70 sm:h-auto sm:min-h-[800px] sm:p-3 lg:p-4 xl:order-1 xl:min-h-[880px]">
            <CicloVisual
