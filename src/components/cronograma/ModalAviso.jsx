...
const ModalAviso = ({ onConfirmar, onCancelar, titulo, descricao, icone, cor }) => (
  ...
  >
    <motion.div
      ...
      className="bg-white dark:bg-card-dark w-full max-w-sm rounded-3xl shadow-2xl border border-zinc-200 dark:border-zinc-800 overflow-hidden"
    ...
    >
      ...
      <div className="p-4 flex gap-3 bg-white dark:bg-card-dark">
