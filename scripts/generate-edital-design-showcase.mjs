...
import { createEditalVerticalizadoDesignShowcasePdf } from '../src/pages/EditalVerticalizadoPdf.js';
...
const doc = await createEditalVerticalizadoDesignShowcasePdf({
...
const outputPath = resolve(outputDir, 'estudos-capa-encerramento-edital-verticalizado.pdf');
