...
import { createTacticalCoverOptionsPdf } from '../src/pages/EditalVerticalizadoPdf.js';
...
const doc = await createTacticalCoverOptionsPdf({
...
const outputPath = resolve(outputDir, 'capas-grade-tatica-soldado-pmal.pdf');
